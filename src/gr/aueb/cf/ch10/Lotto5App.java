...
//                pivot++;
     ...
     * @return true, if the number of evens is grreater than or equal to the thershold, false otherwise
     */
    ...
    /**
     * Returns true if the number of odds is Greater than or equal to a threshold limit.
     * @param arr the input array
     * @param threshold the upper limit of the constraint
     * @return true, if the number of odds is greater than or equal to the threshold, false otherwise
     */
